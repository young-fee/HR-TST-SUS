...
<div class="demoTable" style="width: 100%;display: block;height: 50px;padding-top: 10px;" >
        ...
        <form class="layui-form" action = "addRoleToUser" style="float: right">
            <div class="layui-form-item"  style="float: left">
                <div class="layui-inline">
                <input type="hidden" id="userLoginId" name = "userLoginId" value="${userLoginId}">
...
<script>
    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,url: 'showUserRole?userLoginId='+userLoginId
            ,cellMinWidth: 80
            ,cols: [[
        ...
        table.on('tool(user)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'del'){ //删除
                layer.confirm('真的删除行么', function(index){
                     ...
                     layer.close(index);
                   //向服务端发送删除指令
        	     	   window.location.href = "delUserRole?roleId="+data.roleId+"&userLoginId="+$("#userLoginId").val();
            })
            }
        });
    });
